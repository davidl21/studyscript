...
const HeroSection = () => {
  ...
  const [wordsInRotation, setWordsInRotation] = useState([
    "faster",
    "smarter",
    "easier",
  ]);
  ...
  return (
    <section className="flex flex-col items-center mt-6 lg:mt-20">
      <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center font-thin">
        ...
        <span className="block mt-3">{currentEmoji}</span>
      </h1>
      <p className="mt-10 text-center text-neutral-500 max-w-4xl font-light">
        Unlock your personal 24/7 tutor to help you power through your online
        video lectures. Ask questions, have conversations, and understand any
